    ...
    if not os.path.exists(
        ...
        for data_split in ["train", "dev", "test"]:
            ...
            for root, dirs, files in os.walk(data_dir):
                ...
                for f in tqdm(
                    fs, desc="processing schema-guided-{}".format(data_split)
                ):
        ...
        os.remove("data.json")
        print(
            "# train dialog: {}, # train utterance: {}".format(
...
if __name__ == "__main__":
    ...
    print(
        match
    )  # {'0': 4146, '1': 53626, '>1': 2904} =>(after user act released) {'0': 487, '1': 63886, '>1': 3097}

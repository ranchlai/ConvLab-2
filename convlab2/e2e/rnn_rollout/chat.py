...
def main():
    ...
    parser.add_argument(
        "--num_objects", type=int, default=6, help="total number of objects"
    )
    parser.add_argument(
        "--max_score", type=int, default=10, help="max score per object"
    )
    parser.add_argument(
        "--score_threshold",
        type=int,
    ...
    if args.context_file == "":
        ctx_gen = ManualContextGenerator(
            args.num_types, args.num_objects, args.max_score
        )
    else:

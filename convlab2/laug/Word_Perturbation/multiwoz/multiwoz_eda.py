    ...
    def _augment_sample(
        ...
        for turn_index, turn in iter_dialogues(sample, mode=mode):
            ...
            try:
                ...
                assert is_span_info_consistent_with_text(
                    augmented_sentence, augmented_span_info
                ), p_str([orig_turn, turn])
                augmented = True
                turn = {
                    ...
                    **{
                        ...
                        if k not in ("text", "span_info", "dialog_act")
                    },
                }

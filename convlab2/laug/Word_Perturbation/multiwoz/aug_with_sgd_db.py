...
class multiwoz_eda_config:
    def __init__(
        ...
        self.multiwoz = read_zipped_json(
            os.path.join(DATA_ROOT, "multiwoz", "train.json.zip"), "train.json"
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--alpha_rs", type=float, default=0.1, help="probability of swap"
    )
    parser.add_argument(
        "--p_rd", type=float, default=0.1, help="probability of deletion"
    )
    parser.add_argument(
        "--num_aug",
        type=int,

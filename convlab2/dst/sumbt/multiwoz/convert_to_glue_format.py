                    ...
                    for domain in data[file_id]["log"][idx]["metadata"].keys():
                        for slot in data[file_id]["log"][idx]["metadata"][
                            ...
                            if (
                                ...
                                or value == "don't care"
                                or value == "dont care"
                                or value == "does not care"
                                or value == "dontcare"
                            ):
                                value = "do not care"
                            elif (
                                value == "guesthouse" or value == "guesthouses"
                            ):
                                value = "guest house"
                            elif (
                                value == "city center"
                                or value == "town centre"
                                or value == "town center"
                                or value == "centre of town"
                                or value == "center"
                                or value == "center of town"
                            ):
                                value = "centre"
                        ...
                        for slot in data[file_id]["log"][idx]["metadata"][
                            ...
                            if (
                                value not in ontology[domain]["book " + slot]
                                and value != "none"
                            ):

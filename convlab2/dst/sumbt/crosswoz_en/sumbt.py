...
crosswoz_en_slot_list = [
    "Attraction-duration",
    "Attraction-fee",
    "Attraction-name",
    "Attraction-nearby attract.",
    "Attraction-nearby hotels",
    "Attraction-nearby rest.",
    "Attraction-rating",
    "Hotel-Hotel Facilities - 24-hour Hot Water",
    "Hotel-Hotel Facilities - Bar",
    "Hotel-Hotel Facilities - Breakfast Service",
    "Hotel-Hotel Facilities - Broadband Internet",
    "Hotel-Hotel Facilities - Business Center",
    "Hotel-Hotel Facilities - Car Rental",
    "Hotel-Hotel Facilities - Chess-Poker Room",
    "Hotel-Hotel Facilities - Childcare Services",
    "Hotel-Hotel Facilities - Chinese Restaurant",
    "Hotel-Hotel Facilities - Disabled Facilities",
    "Hotel-Hotel Facilities - Foreign Guests Reception",
    "Hotel-Hotel Facilities - Free Breakfast Service",
    "Hotel-Hotel Facilities - Free Domestic Long Distance Call",
    "Hotel-Hotel Facilities - Free Local Calls",
    "Hotel-Hotel Facilities - Gym",
    "Hotel-Hotel Facilities - Hair Dryer",
    "Hotel-Hotel Facilities - Heating",
    "Hotel-Hotel Facilities - Hot Spring",
    "Hotel-Hotel Facilities - Indoor Swimming Pool",
    "Hotel-Hotel Facilities - International Call",
    "Hotel-Hotel Facilities - Laundry Service",
    "Hotel-Hotel Facilities - Luggage Storage",
    "Hotel-Hotel Facilities - Meeting Room",
    "Hotel-Hotel Facilities - Non-smoking Room",
    "Hotel-Hotel Facilities - Outdoor Swimming Pool",
    "Hotel-Hotel Facilities - Pay Parking",
    "Hotel-Hotel Facilities - Pick-up Service",
    "Hotel-Hotel Facilities - SPA",
    "Hotel-Hotel Facilities - Sauna",
    "Hotel-Hotel Facilities - Wake Up Service",
    "Hotel-Hotel Facilities - Western Restaurant",
    "Hotel-Hotel Facilities - WiFi in All Rooms",
    "Hotel-Hotel Facilities - WiFi in Public Areas",
    "Hotel-Hotel Facilities - WiFi in Public Areas and Some Rooms",
    "Hotel-Hotel Facilities - WiFi in Some Rooms",
    "Hotel-Hotel Facilities - WiFi throughout the Hotel",
    "Hotel-name",
    "Hotel-nearby attract.",
    "Hotel-nearby hotels",
    "Hotel-nearby rest.",
    "Hotel-price",
    "Hotel-rating",
    ...
    "Restaurant-dishes",
    "Restaurant-name",
    "Restaurant-nearby attract.",
    "Restaurant-nearby hotels",
    "Restaurant-nearby rest.",
    "Restaurant-rating",
    "Taxi-from",
    "Taxi-to",
]
...
class SUMBTTracker(DST):
    ...
    def __init__(self, data_dir=DATA_PATH):
        ...
        for labels in label_list:
            ...
            token_ids, lens = get_label_embedding(
                labels, args.max_label_length, self.tokenizer, self.device
            )
        ...
        self.train_examples = processor.get_train_examples(
            os.path.join(SUMBT_PATH, args.tmp_data_dir), accumulation=False
        )
        self.dev_examples = processor.get_dev_examples(
            os.path.join(SUMBT_PATH, args.tmp_data_dir), accumulation=False
        )
            ...
            if os.path.isfile(os.path.join(DOWNLOAD_DIRECTORY, "pytorch_model.bin")):
                ...
                self.load_weights(
                    model_path=os.path.join(
                        SUMBT_PATH, args.output_dir, "pytorch_model.bin"
                    )
                )
            else:
    ...
    def train(self, load_model=False, model_path=None):
        ...
        all_input_ids, all_input_len, all_label_ids = (
            all_input_ids.to(DEVICE),
            all_input_len.to(DEVICE),
        ...
        all_input_ids_dev, all_input_len_dev, all_label_ids_dev = (
            all_input_ids_dev.to(DEVICE),
            all_input_len_dev.to(DEVICE),
            all_label_ids_dev.to(DEVICE),
        )
        ...
        dev_dataloader = DataLoader(
            dev_data, sampler=dev_sampler, batch_size=args.dev_batch_size
        )
                ...
                if N_GPU == 1:
                    for i, slot in enumerate(self.processor.target_slot):
                        summary_writer.add_scalar(
                            ...
                            dev_loss_slot[i] / nb_dev_examples,
                            global_step,
                        )
                        summary_writer.add_scalar(
    ...
    def test(
        ...
        eval_dataloader = DataLoader(
            eval_data, sampler=eval_sampler, batch_size=args.dev_batch_size
        )
            ...
            with torch.no_grad():
                if not USE_CUDA or N_GPU == 1:
                    loss, loss_slot, acc, acc_slot, pred_slot = model(
                        input_ids, input_len, label_ids, 1
                    )
                else:
        ...
        if not USE_CUDA or N_GPU == 1:
            result = {
                ...
                "eval_acc_slot": "\t".join(
                    [str((val).item()) for val in eval_acc_slot]
                ),
            }
        else:
            result = {

...
# Training Setting
parser.add_argument(
    "-ds", "--dataset", help="dataset", required=False, default="multiwoz"
)
...
parser.add_argument(
    "-sample", "--sample", help="Number of Samples", required=False, default=None
)
parser.add_argument(
    "-patience", "--patience", help="", required=False, default=6, type=int
)
parser.add_argument(
    "-es",
    "--earlyStop",
...
parser.add_argument(
    "-all_vocab", "--all_vocab", help="", required=False, default=1, type=int
)
parser.add_argument(
    "-imbsamp", "--imbalance_sampler", help="", required=False, default=0, type=int
)
parser.add_argument(
    "-data_ratio", "--data_ratio", help="", required=False, default=100, type=int
)
parser.add_argument(
    "-um",
    "--unk_mask",
...
# Testing Setting
parser.add_argument(
    "-rundev", "--run_dev_testing", help="", required=False, default=0, type=int
)
parser.add_argument(
...
## model predictions
parser.add_argument(
    "-gs", "--genSample", help="Generate Sample", type=int, required=False, default=0
)  #### change this when testing
parser.add_argument(
    "-evalp", "--evalp", help="evaluation period", required=False, default=1
)
parser.add_argument(
    "-an",
    "--addName",
    help="An add name for the model folder",
    required=False,
    default="",
)
parser.add_argument(
...
parser.add_argument(
    "-le", "--load_embedding", help="", required=False, default=0, type=int
)
parser.add_argument(
    "-femb", "--fix_embedding", help="", required=False, default=0, type=int
)
parser.add_argument(
    "-paral", "--parallel_decode", help="", required=False, default=0, type=int
)

# Model Hyper-Parameters
parser.add_argument("-dec", "--decoder", help="decoder model", required=False)
parser.add_argument(
    "-hdd", "--hidden", help="Hidden size", required=False, type=int, default=100
)
...
parser.add_argument(
    "-clip", "--clip", help="gradient clipping", required=False, default=10, type=int
)
parser.add_argument(
    "-tfr",
...
parser.add_argument(
    "-exceptd", "--except_domain", help="", required=False, default="", type=str
)
parser.add_argument(
    "-onlyd", "--only_domain", help="", required=False, default="", type=str
)

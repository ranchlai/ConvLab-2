...
class dataset(torch_data.Dataset):
    def __init__(
        self, src1, src2, src3, tgt, tgtv, tgtpv
    ):  # raw_src1, raw_src2, raw_src3, raw_tgt):
...
def padding(data):
    ...
    for src1, src2, src3, tgt, tgtv, tgtpv in zip(
        src1_iter, src2_iter, src3_iter, tgt_iter, tgtv_iter, tgtpv_iter
    ):

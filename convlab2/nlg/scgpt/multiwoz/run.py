...
def main():
    ...
    parser.add_argument("--input_file", type=str, default=None, help="file")
    ...
    tokenizer = tokenizer_class.from_pretrained(
        args.model_name_or_path, pad_token="<PAD>", padding_side="left"
    )
    ...
    for idx in range(0, len(inputs), args.batch_size):
        ...
        out_ids = out_ids.reshape(len(raw_inputs), args.num_samples, -1)[
            :, :, max_length:
        ].tolist()
